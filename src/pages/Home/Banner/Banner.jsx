    ...
    <div className="sm:p-0 p-1 my-15">
      ...
      <div className="flex w-full justify-center items-center gap-2 py-2 h-10">
        <a
          ...
          className={activeItem === "item1" ? "text-xl" : "text-sm"}
        >
          <GoDotFill />
        </a>
        <a
          ...
          className={activeItem === "item2" ? "text-xl" : "text-sm"}
        >
          <GoDotFill />
        </a>
        <a
          ...
          className={activeItem === "item3" ? "text-xl" : "text-sm"}
        >
          <GoDotFill />
        </a>
        <a
          ...
          className={activeItem === "item4" ? "text-xl" : "text-sm"}
        >
          <GoDotFill />
        </a>
      </div>
